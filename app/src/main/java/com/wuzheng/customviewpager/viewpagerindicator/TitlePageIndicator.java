...
import com.wuzheng.customviewpager.R;
...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // mCurrentPage is -1 on first start and after orientation changed. If so, retrieve the correct index_activity from viewpager.
    ...
    /**
     * Calculate views bounds and scroll them according to the current index_activity
     *
     * @param paint
     * @return
     */
